...
#define OLD_FILE_NAME MNT_POINT"/rename03_oldfile"
#define NEW_FILE_NAME MNT_POINT"/rename03_newfile"
#define OLD_DIR_NAME MNT_POINT"/rename03_olddir"
#define NEW_DIR_NAME MNT_POINT"/rename03_newdir"
